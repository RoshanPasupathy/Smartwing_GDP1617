...
//#define SPICS 10
#define MCP2515_SELECT()   SPI.beginTransaction(SPISettings(10000000, MSBFIRST, SPI_MODE0)); digitalWrite(SPICS, LOW)
#define MCP2515_UNSELECT() digitalWrite(SPICS, HIGH); SPI.endTransaction()
